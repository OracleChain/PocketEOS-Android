...
//创建账号
public class CreateAccounntActivity extends BaseAcitvity<CreateAccountView, CreateAccountPresenter> implements CreateAccountView {
    ...
    public void onViewClicked() {
        if (RegexUtil.isEosName(mAccountName.getText().toString())) {
            PasswordDialog dialog = new PasswordDialog(CreateAccounntActivity.this, new PasswordCallback() {
                @Override
    ...
    public CreateAccountPresenter initPresenter() {
        return new CreateAccountPresenter(CreateAccounntActivity.this);
    }
    ...
    public void initEvent() {
        ...
        mGoImportAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityUtils.next(CreateAccounntActivity.this, ImportAccountActivity.class, bundle);
            }
        });
        mGoPocketeosUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bundle.putString("details", FilesUtils.readAssetsTxt(CreateAccounntActivity.this, "pocketeos_user"));
                bundle.putString("title", getString(R.string.setting_one));
                ActivityUtils.next(CreateAccounntActivity.this, RichTextActivity.class, bundle);
            }
        });
        mGoMapAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityUtils.next(CreateAccounntActivity.this, MapAccountActivity.class);
            }
        });
    }
}
